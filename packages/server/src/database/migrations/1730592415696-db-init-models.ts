...
export class DbInitModels1730592415696 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "leagues" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_2275e1e3e32e9223298c3a0b514" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "event_user_league" ("id" SERIAL NOT NULL, "event_id" integer NOT NULL, "user_id" integer NOT NULL, "league_id" integer NOT NULL, CONSTRAINT "UQ_87dbc8e4fcfbb6126113c3fed1e" UNIQUE ("event_id", "user_id", "league_id"), CONSTRAINT "PK_daa5e465cdb8eb574ea3cfc299c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "event_user_league" ADD CONSTRAINT "FK_709cba3d15f4ce547b3c17215a6" FOREIGN KEY ("event_id") REFERENCES "events"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "event_user_league" ADD CONSTRAINT "FK_9d6145b234e60f175ea95a148ef" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "event_user_league" ADD CONSTRAINT "FK_dbd2e2c562bb8a07dabbeb8f955" FOREIGN KEY ("league_id") REFERENCES "leagues"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "event_user_league" DROP CONSTRAINT "FK_dbd2e2c562bb8a07dabbeb8f955"`,
    );
    await queryRunner.query(
      `ALTER TABLE "event_user_league" DROP CONSTRAINT "FK_9d6145b234e60f175ea95a148ef"`,
    );
    await queryRunner.query(
      `ALTER TABLE "event_user_league" DROP CONSTRAINT "FK_709cba3d15f4ce547b3c17215a6"`,
    );
    await queryRunner.query(
