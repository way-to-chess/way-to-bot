      ...
      tgBotEventErrorHandler("message", async (msg: Message) => {
        ...
        if (text === "/start") {
          ...
          return this.bot.sendMessage(
            ...
            Там ты найдешь всю информацию о предстоящих/текущих/прошедших событиях, сможешь оставить заявку на участие, освежить в памяти результаты турнира 🏆
            Всю информацию о твоих успехах смотри в вкладке профиля 🥇🥈🥉
            
            
            Предложения и идеи по улучшению приложения принимаются ♚ @Roman_Comandorb .
